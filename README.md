...
- Improved code for better reading and understanding and modification.
...
* ([model.py](mrcnn/model.py), [utils.py](mrcnn/Utils/utilfunctions.py), [config.py](mrcnn/Configs/_config.py)): These files contain the main Mask RCNN implementation. 
